...
```{r 2. Trap Effort - Fall Plot, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 15, fig.height = 5, fig.cap = "Figure 2. Fall adult trapping effort, presented as the proportion of sample years when trapping was completed on each date.", fig.topcaption = TRUE}
...
```{r 4. Fish Captures - Annual Spring Catch Plot - Spring, echo=FALSE, warning=FALSE, message = FALSE}
