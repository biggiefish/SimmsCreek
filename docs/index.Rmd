...
2.  Whether the current fence operation program is capturing the complete migration period?

3.  When are key behaviours occurring (e.g., when is peak smolt? when do adults arrive?) and are they occurring at consistent times each year?
...
6. What factors may be driving variability in the number of CCT and CO smolts outmigrating each spring and the number of adult CO returning each fall.
...
```{r 4. Fish Captures - values for text}
...
```{r Annual Captures - Spring Summary Table, echo=FALSE, warning=FALSE, message = FALSE}
## Kable - Master Summary ----
options(knitr.kable.NA = '-')
...
#### Figure 5. Spring - Overall Capture Timing
```{r 5. Capture Timing - Spring - Overall Median Capture Timing, fig.cap = "Figure 5. Overall median spring capture timing.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 6}
Spring.Boxplot.Summary
```

#### Figure 5. Spring - Median CO Capture Timing Across Years
```{r 5. Capture Timing - Spring - Median Spring CO Capture Timing, fig.cap = "Figure 6. Median spring cpature timing", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12}
Spring.Boxplot.Years.CO
```

#### Figure 6. Spring - Median CT Capture Timing Across Years
```{r 5. Capture Timing - Spring - Median Spring CCT Capture Timing, fig.cap = "Figure 7. Median spring cpature timing", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12}
Spring.Boxplot.Years.CO
```

#### Figure 7. Spring - Frequency of Peak CCT Migration
```{r 5. Capture Timing - Spring - Frequency of Peak CT Capture, fig.cap = "Figure 8. Frequency of peak CCT capture dates during Spring fence monitoring.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12 }
print(CT.peak.spring.plot)
```

#### Figure 8. Spring - Daily captures of CCT per year
```{r 5. Capture Timing - Spring - Daily CT Captures per year, fig.cap = "Figure 9. Total daily capture of CCT and proportion of total annual captures.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 25}

print(daily_catch_plot.Spring.CT)
```

#### Figure 10. Spring - Total daily captures of CCT across years
```{r 5. Capture Timing - Spring - Daily CT Captures Across Years, fig.cap = "Figure 10. Total daily capture of CCT across years.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 12, fig.height = 10}

print(daily_catch_summary_plot.Spring.CT)
```


#### Figure 11. Spring - Frequency of Peak Coho Migration
```{r 5. Capture Timing - Spring - Frequency of Peak CO Capture, fig.cap = "Figure 11. Frequency of peak Coho capture dates during Spring fence monitoring.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12 }

print(CO.peak.spring.plot)

```

#### Figure 12. Spring - Total daily captures of Coho Salmon per year
```{r 5. Capture Timing - Spring - Daily CO Captures per year, fig.cap = "Figure 12. Number of Coho Salmon captured during each day of spring fence operation since 2008.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 25}

print(daily_catch_plot.Spring.CO)
```

#### Figure 13. Spring - Total daily captures of Coho across years
```{r 5. Capture Timing - Spring - Daily CO  Captures Across Years, fig.cap = "Figure 13. Total daily capture of CCT across years.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 12, fig.height = 8}

print(daily_catch_summary_plot.Spring.CO)
```

#### Figure 14. Fall - Overall Capture Timing
```{r 5. Capture Timing - Fall - Overall Median Capture Timing, fig.cap = "Figure 14. Overall median fall capture timing.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 6}
Fall.Boxplot.Summary
```


#### Figure 15. Fall - Median Fall CO Capture Timing Across Years
```{r 5. Capture Timing - Fall - Median Fall CO Capture Timing, fig.cap = "Figure 15. Median fall cpature timing", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12}
Fall.Boxplot.Years.CO
```

#### Figure 16. Fall - Median Fall CT Capture Timing Across Years
```{r 5. Capture Timing - Fall - Median Fall CCT Capture Timing, fig.cap = "Figure 16. Median fall cpature timing", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12}
Fall.Boxplot.Years.CO
```


#### Figure 17. Fall - Frequency of Peak Coho Migration
```{r 5. Capture Timing - Fall - Frequency of Peak CO Capture, fig.cap = "Figure 17. Frequency of peak Coho capture dates during Fall fence monitoring.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 12 }

print(CO.peak.fall.plot)

```

#### Figure 18. Fall - Total daily captures of Coho Salmon per year
```{r 5. Capture Timing - Fall - Daily CO Captures per year, fig.cap = "Figure 18. Number of Coho Salmon captured during each day of fall fence operation since 2008.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 25}

print(daily_catch_plot.Fall.CO)
```

####  Figure 19. Fall - Total daily captures of Coho across years
```{r 5. Capture Timing - Fall - Daily CO  Captures Across Years, fig.cap = "Figure 19. Total daily capture of CCT across years.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 12, fig.height = 8}

print(daily_catch_summary_plot.Fall.CO)
```



#### Figure 20. Fall - Daily captures of CCT per year
```{r 5. Capture Timing - Fall - Daily CT Captures per year, fig.cap = "Figure 20. Total daily capture of CCT and proportion of total annual captures.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 10, fig.height = 25}

print(daily_catch_plot.Fall.CT)
```

#### Figure 21. Fall - Total daily captures of CCT across years
```{r 5. Capture Timing - Fall - Daily CT Captures Across Years, fig.cap = "Figure 21. Total daily capture of CCT across years.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 12, fig.height = 10}

print(daily_catch_summary_plot.Fall.CT)
```
...
```{r 6. Length Frequency - CT Length Frequency All Years Combined, fig.cap = "Figure 13. Length Frequency of all CCT.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 8, fig.height = 6}
...
```{r 6. Length Frequency - CO Length Frequency Across Years, fig.cap = "Figure 16. Length Frequency of Coho Salmon across years.", fig.topcaption = TRUE, echo=FALSE, warning=FALSE, message = FALSE, fig.width = 12, fig.height = 20}
