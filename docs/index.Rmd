...
## Simms Creek Coastal Cutthroat Trout

Data presented here was collected by volunteers working with [Greenways Land Trust](https://www.greenwaystrust.ca/)
...
kable(CCT_table,
      ...
      caption = "**Table 1. Total annual captures of Coastal Cutthroat Trout during spring smolt trapping in Simms Creek.**",
      digits = 1) %>%
  ...
  kable_styling("striped", full_width =  FALSE,
                ...
                font_size = 12,
                fixed_thead = TRUE) %>%
  add_header_above(c(" " = 3, "Operation Period" = 3, "","Fork Length (mm)" = 4)) 


```

## Size Distribution of Simms Creek Coastal Cutthroat
